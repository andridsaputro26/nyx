...
import com.project.baranghilang.adapter.PostingBarangHilangAdapterListview;
...
public class BarangHilangActivity extends AppCompatActivity {
...
//                        Toast.makeText(UtamaUserActivity.this, String.valueOf(lstdatatoko.size()),Toast.LENGTH_LONG).show();
                        ...
                        for (int i = 0; i < lstdataposting.size(); i++) {
                            ...
                            vnohpposting[i] =lstdataposting.get(i).getnohp().toString();
                            ...
                            vjenis[i] =lstdataposting.get(i).getstatus().toString();
                            vphotourl[i] = lstdataposting.get(i).getpostingurl().toString();

                        }

                        PostingBarangHilangAdapterListview vadapter = new PostingBarangHilangAdapterListview(BarangHilangActivity.this, vpostingid, vtanggal, vemailposting, vusernameposting,vnohpposting, vjudulposting, vdeskripsi, vlokasi, vjenis, vstatus, vphotourl);
                    ...
                    public void failure(RetrofitError error) {
                        ...
                        Toast.makeText(BarangHilangActivity.this, " Terjadi Kesalahan Kooneksi Category " + merror, Toast.LENGTH_LONG).show();
                    }
                }
        );
